...
@implementation JNFMDBUtil

+ (JNFMDBUtil *)shareInstance {
    static JNFMDBUtil *_instance;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        _instance = [[JNFMDBUtil alloc] init];
    });
    return _instance;
}
...
- (BOOL)openDB {
    ...
    if (!_db) {
        ...
        _db = [FMDatabase databaseWithPath:[JNFileManagerUtil fmdbFileWithMobile:mobile]];
        _dbQueue = [FMDatabaseQueue databaseQueueWithPath:[JNFileManagerUtil fmdbFileWithMobile:mobile]];
    }
